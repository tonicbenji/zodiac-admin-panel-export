...
export class PagesComponent extends BaseListComponent implements OnInit {
    ...
    constructor(
        ...
        super(pageService, injector, 'pages');
        pageService.setType('pages');
