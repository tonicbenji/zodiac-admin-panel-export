...
@Component({
    templateUrl: './poolcatalogues.component.html'
})

export class  PoolCataloguesComponent extends BaseListComponent implements OnInit {
    
    entity: string = 'Pool Catalogues';
    ...
    constructor(
        ...
        super(pageService, injector, 'poolcatalogues');
        pageService.setType('poolcatalogues');
    ...
    ngOnInit(): void {
        this.dtOptions = {
            ...
            pageLength: 25,
            ajax: this.getAjaxConfig('poolcatalogues'),
            "columns": [
              {
                  data: "name",
                  title: "Name"
