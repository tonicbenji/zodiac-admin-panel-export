...
@Component({
    templateUrl: './poolspaguides.component.html'
})

export class  PoolSpaGuidesComponent extends BaseListComponent implements OnInit {
    
    entity: string = 'Pool Spa Guide';
    ...
    constructor(
        ...
        super(pageService, injector, 'poolspaguides');
        pageService.setType('poolspaguides');
    ...
    ngOnInit(): void {
        this.dtOptions = {
            ...
            pageLength: 25,
            ajax: this.getAjaxConfig('poolspaguides'),
            "columns": [
              {
                  data: "name",
                  title: "Name"
