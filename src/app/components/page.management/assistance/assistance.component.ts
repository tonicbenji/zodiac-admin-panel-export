...
export class  AssistanceComponent extends BaseListComponent implements OnInit {
    
    entity: string = 'Equipment Assistance';
    ...
    constructor(
        ...
        super(pageService, injector, 'assistance');
        pageService.setType('assistance');
    ...
    ngOnInit(): void {
        this.dtOptions = {
            ...
            pageLength: 25,
            ajax: this.getAjaxConfig('assistance'),
            "columns": [
                {
                    data: "name",
                    title: "Name"
